...
export const serviceNameContentMap = {
    ...
    "turkish": [
        ...
        \nAyrıca, özellikle kuruluş aşamasında ihtiyaç duyulan gerekli kayıt ve başvuru işlemlerinin yapılması, internet sayfası oluşturma, banka hesabı açma, sosyal medya, reklam ve pazarlama faaliyet çözümleri sunma gibi konularda da çözümler sağlamaktayız.`
        ,
        `Müşterilerimizin ihtiyaç duydukları konularda pazar araştırma faaliyetleri yürütmekteyiz. Araştırmalarımız boyunca anket, gözlem, mülakat gibi nitel yöntemler yanında çeşitli nicel veri toplama ve analiz yöntemleri uygulamaktayız.
        ...
        \nAyrıca, çeşitli alanlarda piyasadaki önemli haberleri ve gelişmeleri kapsayan isteğe bağlı dönemsel haber bültenleri hazırlamaktayız.`
        ,
